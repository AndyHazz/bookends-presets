-- Bookends preset: Maximalist sparkles 2.0
return {
    author = "rillereads",
    defaults = {
        font_scale = 100,
    ...
    description = "for anyone who likes bows, sparkles, and stars",
    name = "Maximalist sparkles 2.0",
    positions = {
        bc = {
            disabled = true,
